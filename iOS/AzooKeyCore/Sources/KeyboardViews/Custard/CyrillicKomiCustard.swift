    ...
    static let cyrillicKomi = Custard(
        ...
        interface: CustardInterface(
            ...
            keys: [
                ...
                .gridFit(.init(x: 9, y: 0)): .custom(.inputWithVariation("з", variation: "ԅ")), // з with ԅ (dz)
                ...
                .gridFit(.init(x: 6, y: 1)): .custom(.inputWithVariation("о", variation: "ӧ")), // о with ӧ
                .gridFit(.init(x: 7, y: 1)): .custom(.inputWithVariation("л", variation: "ԇ")), // л with ԇ (voiceless l)
                .gridFit(.init(x: 8, y: 1)): .custom(.inputWithVariation("д", variation: "ԁ")), // д with ԁ (soft d)
                .gridFit(.init(x: 9, y: 1)): .custom(.inputWithVariation("ж", variation: "ԃ")), // ж with ԃ (dzh)
                ...
                .gridFit(.init(x: 2, y: 2)): .custom(.inputWithVariation("ч", variation: "ԉ")), // ч with ԉ (soft ch)
                .gridFit(.init(x: 3, y: 2)): .custom(.inputWithVariation("с", variation: "ԍ")), // с with ԍ (soft s)
                .gridFit(.init(x: 4, y: 2)): .custom(.input("м")),
                .gridFit(.init(x: 5, y: 2)): .custom(.input("і")), // і - Komi specific
                .gridFit(.init(x: 6, y: 2)): .custom(.inputWithVariation("т", variation: "ԏ")), // т with ԏ (soft t)
